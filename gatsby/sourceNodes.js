        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 15:
            if (_constants.IS_DEV && preview) {
              ...
              BC.post(webhookEndpoint, body).then(function (res) {
                if ("data" in res && Array.isArray(res.data)) {
                  var server = (0, _micro.default)(function () {
                    var _ref4 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(req, res) {
...
exports.onCreateDevServer = function (_ref5) {
  var app = _ref5.app;
