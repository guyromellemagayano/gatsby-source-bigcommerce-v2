...
exports.handleConversionStringToUppercase = exports.handleConversionStringToTitleCase = exports.handleConversionStringToSnakeCase = exports.handleConversionStringToSentenceCase = exports.handleConversionStringToObject = exports.handleConversionStringToNumber = exports.handleConversionStringToLowercase = exports.handleConversionStringToKebabCase = exports.handleConversionStringToConstantCase = exports.handleConversionStringToCamelCase = exports.handleConversionStringToBoolean = exports.handleConversionStringToArray = exports.handleConversionObjectToString = void 0;
...
var handleConversionStringToTitleCase = function handleConversionStringToTitleCase(e) {
  return typeof e === "string" ? e.replace(/\w\S*/g, function (txt) {
...
var handleConversionStringToCamelCase = function handleConversionStringToCamelCase(e) {
  return typeof e === "string" ? e.replace(/([A-Z])/g, " $1").replace(/^./, function (str) {
...
var handleConversionStringToSentenceCase = function handleConversionStringToSentenceCase(e) {
  return typeof e === "string" ? e.replace(/\s/g, " ").replace(/\w\S*/g, function (txt) {
    return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();
  }) : e;
};
