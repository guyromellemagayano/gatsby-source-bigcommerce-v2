...
var Request = function () {
  function Request(hostname, _temp) {
    ...
    hostname == null && headers == null ? function () {
      ...
      var req = _https.default.request(options, function (res) {
        ...
        if (Math.round(statusCode / 100) === 4) {
          if (statusCode === 429) {
            ...
            var xRetryAfterHeader = (_res$headers$xRetry = res === null || res === void 0 ? void 0 : (_res$headers = res.headers) === null || _res$headers === void 0 ? void 0 : _res$headers["x-retry-after"]) !== null && _res$headers$xRetry !== void 0 ? _res$headers$xRetry : null;
